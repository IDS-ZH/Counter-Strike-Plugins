...
{
	name = "ZH Basic Commands",
	author = "AlliedModders LLC & ZH-sys Team",
	description = "Basic Admin Commands (ZH-sys Integrated)",
...
#include "zh_basecommands/kick.sp"
#include "zh_basecommands/reloadadmins.sp"
#include "zh_basecommands/cancelvote.sp"
#include "zh_basecommands/who.sp"
#include "zh_basecommands/map.sp"
#include "zh_basecommands/execcfg.sp"
...
public void OnPluginStart()
{
	...
	// ZH-sys: disable sm_rcon usage in favor of admin menu + web control.
	...
	BuildPath(Path_SM, mapListPath, sizeof(mapListPath), "configs/ZH-sys/Tools/MapCycle/adminmenu_maplist.cfg");
...
// ZH-sys: Command_Rcon removed/hidden as per user preference (using admin menu/web instead)
// But I will keep it commented out or remove it to clean up, as per user rule "vanilla adaptation"
// The original file had it. I will keep it if it was there but I think avoiding conflicts is better.
// Actually, in the read file, Command_Rcon WAS present (lines 382-410).
// However in OnPluginStart, RegAdminCmd("sm_rcon", ...) was NOT present in the file I read!
// Wait, looking at line 70: // ZH-sys: disable sm_rcon usage...
// So it was already modified in the source file I read.
// I will keep my written version consistent with that.
