...
"Resource/HudLayout.res"    // INsanes Blue HUD Tutorial Oct 2011_up to Font shopping and C4 backout Stage
{
	HudHealth
	{
		"fieldName"		"HudHealth"
	...
	HudAccount
	{
		...
		"xpos"	"r123"
		"ypos"	"410"       //"394" //change by INsane lowered
		"wide"	"108"
		"tall"  "25"        //"45" //change by INsane now 25 tall
		"visible" "1"
		"enabled" "1"

		"PaintBackgroundType"	"2"
        "bgcolor_override"		"0 0 0 96"    //change by INsane enabled it

		"icon_xpos"	"9"
		"icon_ypos"	"-4"        // "-4" "16"  change same place as other icon2 and digit2 
		"digit_xpos" "100"
		"digit_ypos" "1"       //"1"  "-4" "16"	change same place as other icon2 and digit2
		"icon2_xpos" "9"
		"icon2_ypos" "-4"
		"digit2_xpos" "100"
		"digit2_ypos" "1"      //"-4"
